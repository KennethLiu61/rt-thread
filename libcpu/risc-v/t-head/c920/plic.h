...
#ifndef C920_PLIC_PHY_ADDR
#define C920_PLIC_PHY_ADDR              (0xF00000000UL)
#endif
#define C920_PLIC_NR_EXT_IRQS           (IRQ_MAX_NR)
#define C920_NR_CPUS                    (NR_CPUS)

/* M and S mode context. */
#define C920_NR_CONTEXT                 (2)
