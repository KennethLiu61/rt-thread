...
void nodechip_gdma_scatter_test(
    ...
    unsigned long long output_addr)
{
    ...
    u64 dst_size = ((src_c_is1 && idx_c_is1) ? 1 : C) * dst_h * src_w; // [1, C or 1, dst_h, src_w]
    dim4 output_shape = {.n = 1, .c = (src_c_is1 && idx_c_is1) ? 1 : C, .h = dst_h, .w = src_w};
    ...
    int src_c_is1_s = 0;
    int idx_c_is1_s = 0;
    int dst_size_s = ((src_c_is1_s && idx_c_is1_s) ? 1 : C_s) * dst_h_s * src_w_s;
    dim4 input_shape_s = {.n = 1, .c = C_s, .h = src_h_s, .w = src_w_s};
    dim4 index_shape_s = {.n = 1, .c = C_s, .h = src_h_s, .w = 1};
    dim4 output_shape_s = {.n = 1, .c = (src_c_is1_s && idx_c_is1_s) ? 1 : C_s, .h = dst_h_s, .w = src_w_s};

    // test S2S
    printf("\nS2S: nC=%d, src_h=%d, src_w=%d, dst_h=%d, src_c_is1=%d, idx_c_is1=%d \n",
            C, src_h, src_w, dst_h, src_c_is1, idx_c_is1);
    tpu_gdma_h_scatter_S2S_ext(output_addr,
                               input_addr,
                               index_addr,
                               0,
                               &output_shape,
    ...
    // test S2L
    printf("\nS2L: nC=%d, src_h=%d, src_w=%d, dst_h=%d, src_c_is1=%d, idx_c_is1=%d \n",
            C_s, src_h_s, src_w_s, dst_h_s, src_c_is1_s, idx_c_is1_s);
    u64 output_s2l_offset = dst_size * tpu_data_type_size(dtype);
    tpu_gdma_cpy_S2L(output_local_addr,
                     output_addr,
                     &output_shape_s,
                     NULL,
                     NULL,
    ...
    // test L2S
    printf("\nL2S: nC=%d, src_h=%d, src_w=%d, dst_h=%d, src_c_is1=%d, idx_c_is1=%d \n",
            C_s, src_h_s, src_w_s, dst_h_s, src_c_is1_s, idx_c_is1_s);
    ...
    tpu_gdma_cpy_S2L(index_local_addr,
                     ...
                     NULL,
                     DT_UINT32);
    tpu_gdma_h_scatter_L2S(output_addr + output_l2s_offset,
                           input_local_addr,
                           index_local_addr,
                           0,
                           &output_shape_s,
    ...
    // test L2L
    printf("\nL2L: nC=%d, src_h=%d, src_w=%d, dst_h=%d, src_c_is1=%d, idx_c_is1=%d \n",
            C_s, src_h_s, src_w_s, dst_h_s, src_c_is1_s, idx_c_is1_s);
    ...
    tpu_gdma_cpy_S2L(index_local_addr,
                     ...
                     DT_UINT32);
    tpu_gdma_cpy_S2L(output_local_addr,
                     output_addr + output_l2l_offset,
                     &output_shape_s,
                     NULL,
                     NULL,
                     dtype);
    tpu_gdma_h_scatter_L2L(output_local_addr,
                           input_local_addr,
                           index_local_addr,
                           0,
                           &output_shape_s,
