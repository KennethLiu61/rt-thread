...
void nodechip_gather_test(global_addr_t index_global) {
    tpu_initialize();
    dim4 stride;
    u64 st = 0, et = 0;
    scalar_t E = {.u32 = 0};
    ...
    } */
    {
        ...
        for (unsigned int d = 0; d < sizeof(dtypes) / sizeof(dtypes[0]); ++d) {
            ...
            printf("%s: "
                   ...
                   "elapsed time=%lldus"
                   "\n",
                   "tpu_bdc_batch_bcast_w_gather(no conflicting)",
                   output_shape.n,
                   output_shape.c,
                   output_shape.w,
                   param_shape.w,
        ...
        for (unsigned int d = 0; d < sizeof(dtypes) / sizeof(dtypes[0]); ++d) {
            ...
            printf("%s: "
                   ...
                   "elapsed time=%lldus"
                   "\n",
                   "tpu_bdc_batch_bcast_w_gather(conflicting)",
                   output_shape.n,
                   output_shape.c,
                   output_shape.w,
                   param_shape.w,
        ...
        for (unsigned int d = 0; d < sizeof(dtypes) / sizeof(dtypes[0]); ++d) {
            ...
            printf("%s: "
                   ...
                   "elapsed time=%lldus"
                   "\n",
                   "tpu_bdc_batch_bcast_w_gather_exception(no conflicting)",
                   output_shape.n,
                   output_shape.c,
                   output_shape.w,
                   param_shape.w,
        ...
        for (unsigned int d = 0; d < sizeof(dtypes) / sizeof(dtypes[0]); ++d) {
            ...
            printf("%s: "
                   ...
                   "elapsed time=%lldus"
                   "\n",
                   "tpu_bdc_batch_bcast_w_gather_exception(conflicting)",
                   output_shape.n,
                   output_shape.c,
                   output_shape.w,
                   param_shape.w,
    ...
    {
        dim4 output_shape = {.n = 4, .c = 64, .h = 256, .w = 4};
        dim4 param_shape = {.n = 1, .c = 64, .h = 256, .w = 4};
        dim4 index_shape = {.n = 4, .c = 64, .h = 256, .w = 1};
        local_addr_t output_addr = 0;
