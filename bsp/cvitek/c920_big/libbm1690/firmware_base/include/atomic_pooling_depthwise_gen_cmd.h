#ifndef ATOMIC_POOLING_DEPTHWISE_GEN_CMD_H
#define ATOMIC_POOLING_DEPTHWISE_GEN_CMD_H
...
void atomic_avg_pooling_fix8b_gen_cmd(
    u32 input_addr,
    u32 pad_ins_addr, // if pad_ins_is_const, store pad_value
    u32 output_addr,
    int input_n,
...
#endif
#endif  /* ATOMIC_POOLING_DEPTHWISE_GEN_CMD_H */